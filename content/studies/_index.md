...
sections:
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |     
        <img src="./Comanche-Springs.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/> 
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <img src="./SvY.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/> 
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <img src="./peocs.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/>  
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <img src="./devils.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/>
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <img src="./Northern_Red_Snapper.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/>
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <img src="./redriver.jpeg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/>
  ...
  - block: markdown
    ...
    content:
      title:
      text: |
        <img src="./sawfish_bethea_noaa.jpg" align="right" style="padding-left:10px; margin-top:10px;" width="600"/>
