...
sections:
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |     
        <h2>Conservation Genomics of the Comanche Springs Pupfish (*Cyprinodon elegans*)</h2> 
  ...
  - block: markdown
    ...
    content:
      title: 
      text: |
        <h2>Using genetics to differentiate between morphologically conserved congeners – scamp, *Mycteroperca phenax*, and yellowmouth grouper, *Mycteroperca interstitialis*</h2>
